...
game_font = pygame.font.Font("font\\04B_19.TTF",20)
...
bg_surface = pygame.image.load("images\\background-night.png")

floor_surface = pygame.image.load("images\\base.png")
floor_x_pos = 0

bird_downflap = pygame.image.load("images\\bluebird-downflap.png")
bird_midflap = pygame.image.load("images\\bluebird-midflap.png")
bird_upflap = pygame.image.load("images\\bluebird-upflap.png")
...
bird_surface = pygame.image.load("images\\bluebird-midflap.png")
bird_rect = bird_surface.get_rect(center = (50,256))
